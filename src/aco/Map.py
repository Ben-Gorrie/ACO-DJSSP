...
class Map:
    ...
    def __init__(self, operations: list, ants: list):
        ...
        self.pheromone_matrix = np.full((self.n_ops, self.n_ops), self.tau_max + 1.5)
    ...
    def calculate_new_pheromone_bounds(self):
        ...
        self.tau_max = 1 / ((1 - self.pheromone_evaporation_coefficient) * self.global_best_makespan)
        ...
        self.tau_min = (self.tau_max * (1 - n_th_root_p_best)) / ((avg - 1) * n_th_root_p_best)
